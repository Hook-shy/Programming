...
function showquestion(ans, index) {
    ...
    $('#question_title').text((index + 1) + '/' + nowquestion.length + ' [单选题] ' + nowquestion[index].title);
    var s = ''
    ...
    s = '<span class="text-success">正确答案：' + order[nowquestion[index].ans] + '</span><br><br>';
